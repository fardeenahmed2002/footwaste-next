...
const Problem = () => {
  ...
  return (
    <div className="relative bg-[url('/reducefoodwastebg.jpg')] bg-cover border-x-[10px] border-[#FFF7E6] border-t-[10px]  min-h-screen pb-10">
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-8 mt-6 px-4">
          {cards.map((card, index) => (
            <motion.div
              key={index}
              className="relative w-[350px] h-[430px] rounded-xl shadow-xl p-6 transition-transform transform hover:scale-[1.03] hover:shadow-2xl overflow-hidden bg-white/10 backdrop-blur-md"
            >
              ...
              <div className="relative z-10 flex flex-col items-center gap-6 h-full">
                ...
                />
                <div className="flex flex-col text-[#FFF7E6] grow">
                  <h1 className="text-3xl font-bold mb-2 text-center">{card.title}</h1>
                  <p className="text-[#FFF7E6] text-[15px] leading-relaxed text-center flex-grow">
                    {card.text}
                  </p>
                  <a
                    href={card.link}
                    ...
                    className="mt-4 self-center font-semibold text-sm bg-black text-white py-2 px-5 rounded-full hover:bg-white hover:text-black transition duration-300 ease-in-out"
                  >
                    View Details
                  </a>
                </div>
