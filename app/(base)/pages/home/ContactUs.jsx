    ...
    >
      ...
      <div className="relative p-8 rounded-lg text-white w-[95%] ml-[35px]">
        ...
        <div className="mt-10 flex flex-col md:flex-row gap-8">
          <div className="flex-1 space-y-6 bg-[#fff7e6] text-[black] bg-opacity-10 p-6 rounded-xl shadow-xl backdrop-blur">
          ...
          <div className="flex-1 space-y-4 bg-white bg-opacity-10 p-6 rounded-xl shadow-xl backdrop-blur">
            <div className="flex gap-2">
              <input
                ...
                className="w-full px-4 py-2 rounded-lg text-black border-[black] border-2 "
              />
              <button
